...
return (
    <nav className="items-center cursor-pointer text-black hover:text-gray-500 font-bold">
        <details className="group h-atuo w-auto open:h-auto overflow-hidden my-1 transition-all duration-500">
            <summary
                className="level-0 flex items-center text-gray-300 hover:text-gray-100 hover:bg-gray-700/75 h-[50px] rounded-md">
