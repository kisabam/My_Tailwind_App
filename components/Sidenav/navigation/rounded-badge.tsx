...
export default function Rounded_Badge() {
    return (
        <nav className="items-center duration-300 cursor-pointer hover:text-gray-500 font-bold">
            <Link href="" className="flex text-gray-400 hover:text-gray-100 hover:bg-gray-700/75 rounded-md my-1 h-[40px]">
                ...
                <h1 className="ms-5 font-[500] text-[14px] mt-2">Rounded Badge</h1>
                <span className="ml-auto mt-2.5 bg-teal-400 text-black text-[11px] font-medium me-2 flex items-center justify-center w-10 h-4 rounded-xl">NEW</span>
            </Link>
        </nav>
    );
}